$(document).ready(function () {
    ...
    $('#searchIcon').click(function () {
        ...
        if (city != '') {
            $.ajax({
                url: "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=imperial" + "&APPID=da12e8ecaaceb8ebcb577b83a0946cb7",
                type: "GET",
                dataType: "jsonp",
...
function show(data) {
    return "<h3 style='font-size:40px; font-weight: bold;' class='text-center'> Current Weather for " + data.name + ", " + data.sys.country + data.dt + "</h3>" +
        ...
        "<h5><strong>Description</strong>: <img src='https://openweathermap.org/img/wn/" + data.weather[0].icon + ".png'> " + data.weather[0].description + "</h5>" +
